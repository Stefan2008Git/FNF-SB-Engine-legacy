...
{
    public var currentlyDifficulty:Int;
    ...
    public function new(currentlyDifficulty:Int)
    {
        super();

        this.currentlyDifficulty = currentlyDifficulty;
    }
    ...
    override function create():Void
    {
        ...
        var file:ReplayFile = Json.parse(File.getContent(SUtil.getPath() + Paths.getPreloadPath('replays/$_song $currentlyDifficulty.json')));
    ...
    override function update(elapsed:Float):Void
    {
        ...
        autoplayTxt.text = "REPLAY";
        autoplayTxt.visible = true;
    ...
    override function keyfreak():Void
    {
    ...
    public static function stringify(?returnString:Bool = true):Dynamic
    {
        var replayFile:ReplayFile = {
            ...
            currentDifficulty: PlayState.storyModeDifficulty
        };
