...
class FlashingScreenState extends MusicBeatState {
	...
	override function create() {
		...
		#if android
		warningText = new FlxText(0, 0, FlxG.width, LanguageHandler.warningTxtAndroid + MainMenuState.sbEngineVersion + "", 32);
		#else
		warningText = new FlxText(0, 0, FlxG.width, LanguageHandler.warningTxt + MainMenuState.sbEngineVersion + "", 32);
		#end
