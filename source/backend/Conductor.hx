...
class Conductor
{
	...
	public static var safeZoneOffset:Float = (backend.ClientPrefs.safeFrames / 60) * 1000; // is calculated in create(), is safeFrames in milliseconds
	...
	public static function mapBPMChanges(song:SwagSong)
	{
		...
		trace("Brand new BPM: " + bpmChangeMap);
	}
