...
class ResultsScreenSubState extends MusicBeatSubstate {
	...
	public function new(daResults:Array<Int>, campaignScore:Int, songMisses:Int, ratingPercent:Float, ratingName:String) {
		...
		resultsText.setFormat(Paths.font("bahnschrift.ttf"), 48, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		results.setFormat(Paths.font("bahnschrift.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		songNameText.setFormat(Paths.font("bahnschrift.ttf"), 72, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		judgementCounterTxt.setFormat(Paths.font("bahnschrift.ttf"), 36, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
