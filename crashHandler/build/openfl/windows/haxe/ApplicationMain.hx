...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SBCrashHandler", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SBCrashHandler", null, 500, 466);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "837";
		app.meta["company"] = "";
		app.meta["file"] = "SBCrashHandler";
		app.meta["name"] = "SB Engine Crash Handler";
		app.meta["packageName"] = "CrashHandler";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("CrashHandler")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess CrashHandler.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"CrashHandler\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"CrashHandler\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends CrashHandler {}
#else
class DocumentClass
{
